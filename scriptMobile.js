...
map.once('idle', function() {
  ...
  $.getJSON('orti.geojson', function(geojson) {
    ...
    document.getElementById('IPV').onclick = function() {
      ...
      $("#sidebar").css("width", "calc(100% - 66px)");
...
$("#close").on("click", function() {
  ...
  setTimeout(function() {
    ...
    $("#sidebar h1").css("padding-top", "105px")
    $("#sidebar h1").css("font-size", "45px")
...
function addInfo() {
  ...
  $("#sidebar").css("margin-top", "50vh");

  $("#sidebar").css("background", "#172424");
  $("#map").css("transform", "translateX(0%)");
  ...
  $("#map").css("transform", "translateY(-50%)");
